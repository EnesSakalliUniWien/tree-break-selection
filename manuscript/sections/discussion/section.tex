...
Third, the context-weighted empirical-null inflation is a diagnostic scale
model rather than an exact selective-inference theorem, so the current same-
selected-hierarchy positive-dimensional path fails closed. Fourth, the final
