...
Sibling test & Projected Wald test; same-selected-hierarchy positive-dimensional calibration fails closed pending a validated reference law \\
Sibling dimension rule & Geometric mean of positive child edge dimensions \\
Sibling basis / inflation & Parent PCA head capped to available rank; projected chi-square raw test; empirical inflation $\hat c$ retained as a diagnostic scale estimate \\
